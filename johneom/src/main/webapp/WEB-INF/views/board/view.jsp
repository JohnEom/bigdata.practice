...
// 		alert(pw);
		...
		alert("비밀번호는 4자 이상 50자 이하입니다.")
		
		return false; //폼 태그든지 앵커 태그든지 화면 이동을 막는다.//스크립트만 실행
		});
});
</script>
</head>
...
<%-- 	<a href="delete.do?no=${vo.no}" class="btn btn-defualt">삭제</a> --%>
